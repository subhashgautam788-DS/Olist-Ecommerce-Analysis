...
----------------------------------------------------------------
--     Section 5: Revenue and delivery analysis
-------------------------------------------------------------
...
----------------------------------------------------
--       Section 7: Product and category analysis
-- -------------------------------------------------

-------------------------------------------------------------------
-- Q11. Average Review Score by Product Category (Top 10)
-- Tables: reviews, order_items, products, product_category_translation
--------------------------------------------------------------
SELECT
...
-- Tables    : orders, order_items, products, product_category_translation
-------------------------------------------------------------------
SELECT
    pct.product_category_name_english AS category_name,
...
---------------------------------------------------
--         Section 8: Revenue and trend analysis
---------------------------------------------------
