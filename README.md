...
> 📥 **[Download Full Report — Olist_Ecommerce_Analysis_Report.pdf](./Report/Olist_Ecommerce_Analysis_Report.pdf)**

The report covers all findings, SQL methodology, KPIs, business recommendations, and advanced analytics (RFM segmentation, MoM growth, seller churn).
...
│   └── Operations___Seller_Performance.png
│   └── Advanced_Customer_Analytics.png
│
...
3. Open `SQL/olist.sql` in pgAdmin or any PostgreSQL client
...
🔗 [linkedin.com/in/subhash-g-a6126626b](https://www.linkedin.com/in/subhash-g-a6126626b/)
